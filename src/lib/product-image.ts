...
const NAME_DEFAULTS: Record<string, string> = {
  ...
  'Spanish Latte': unsplash('photo-1461023058943-07fcbe16d735'),
  'Irish Latte': unsplash('photo-1541167760496-1628856ab772'),
  'Iced Spanish Latte': unsplash('photo-1511920170033-f8396924c348'),
  'Iced Irish Latte': unsplash('photo-1495474472287-4d71bcdd2085'),
